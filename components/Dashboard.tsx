...
const Dashboard: React.FC<DashboardProps> = ({ user, incidents, students, classes, onSave, onDelete, onLogout, onOpenSearch, onUpdateIncident, onSyncStudents, onLoadFullStudentHistory, onLoadArchivedIncidents, onToggleView, viewMode }) => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-900 via-blue-950 to-black font-sans pb-12 overflow-x-hidden" style={{ paddingTop: headerHeight }}>
        ...
        {activeTab === 'registros' && (
          <>
            <div className="bg-white rounded-[32px] shadow-2xl overflow-hidden border border-white/10">
              ...
              <div className="p-6 sm:p-10 bg-gradient-to-br from-blue-900 via-blue-950 to-black">
