...
const Dashboard: React.FC<DashboardProps> = ({ user, incidents, totalIncidentsCount, professorIncidentsCount, managementIncidentsCount, students, classes, onSave, onDelete, onLogout, onOpenSearch, onUpdateIncident, onSyncStudents, onLoadFullStudentHistory, onLoadArchivedIncidents, onToggleView, viewMode }) => {
