              ...
              <div className="flex flex-col sm:flex-row gap-3 items-end">
                ...
                <div className="w-full sm:w-44 space-y-1">
                  ...
                  <StripedSelect
                    ...
                    triggerClassName="w-full h-11 px-4 bg-white border border-gray-200 rounded-2xl text-[10px] font-bold outline-none focus:ring-2 focus:ring-purple-500 transition-all text-black cursor-pointer"
                  />
                </div>
                <button
