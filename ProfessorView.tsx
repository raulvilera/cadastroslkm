...
const ProfessorView: React.FC<ProfessorViewProps> = ({
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-200 via-lime-200 to-sky-200 font-sans pb-12" style={{ paddingTop: headerHeight }}>
      ...
      <main className="max-w-7xl mx-auto mt-8 px-6 space-y-8">
        {/* FORMULÁRIO */}
        <div className="bg-gradient-to-br from-orange-200 via-lime-200 to-sky-200 rounded-xl shadow-2xl overflow-hidden border border-white/5">
          ...
          <div className="p-8 bg-gradient-to-br from-orange-200 via-lime-200 to-sky-200">
